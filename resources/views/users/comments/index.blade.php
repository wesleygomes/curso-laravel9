...
@section('content')
    <h1 class="text-2xl font-semibold leading-tigh py-2">
        ...
        <a href="#" class="bg-cyan-400 rounded-full px-4 text-md">Novo</a>
    </h1>
        ...
        <table class="min-w-full leading-normal shadow-md rounded-lg overflow-hidden">
            ...
            <tbody>
                @foreach ($comments as $comment)
                    <tr>
                        <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm"> {{ $comment->text }} </td>
    ...
    @else
        <h1 class="text-2xl font-semibold leading-tigh py-2">Nenhum comentario cadastrado</h1>
    @endif
@endsection
