...
@section('content')
    <h1 class="text-2xl font-semibold leading-tigh py-2">
        ...
        {{-- <a href="{{ route('users.create') }}" class="bg-blue-900 rounded-full text-white px-4 text-sm">Novo</a> --}}

        <a href="{{ route('users.create') }}" class="bg-cyan-400 rounded-full px-4 text-md">Novo</a>
    </h1>
